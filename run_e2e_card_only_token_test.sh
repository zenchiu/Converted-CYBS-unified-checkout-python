#!/bin/bash
# E2E test for card-only-token-with-prefix config
# Uses: default-uc-capture-context-request-card-only-token-with-prefix.json
...
echo "=============================================="
echo "  E2E Test: card-only-token-with-prefix"
echo "  Config: requestSaveCard, includeCardPrefix"
echo "  OTP: 1234, Save card: ticked"
echo "=============================================="
echo ""
...
echo ""
echo "Running test..."
python test_e2e_card_only_token.py ${1:-} 2>&1 | tee e2e_card_only_token_log.txt
